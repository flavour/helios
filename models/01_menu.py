    ...
    "hrm": {
        ...
        "conditional3": [
            ...
            [T("Skill Catalog"),
             False, URL(f="skill"), [
                [T("New Skill"),
                 False, aURL(p="create", f="skill", args="create")],
                [T("List All"),
                 False, aURL(f="skill")],
                #[T("Skill Provisions"),
                # False, aURL(f="skill_provision")],
           ]],
            [T("Training Course Catalog"),
             False, URL(f="course"), [
                [T("New Training Course"),
                 False, aURL(p="create", f="course",
                             args="create")],
                [T("List All"),
                 False, aURL(f="course")],
                [T("Course Certificates"),
                 False, aURL(f="course_certificate")],
            ]],
            [T("Certificate Catalog"),
             False, URL(f="certificate"), [
                [T("New Certificate"),
                 False, aURL(p="create", f="certificate",
                             args="create")],
                [T("List All"),
                 False, aURL(f="certificate")],
                [T("Skill Equivalence"),
                 False, aURL(f="certificate_skill")],
            ]],
